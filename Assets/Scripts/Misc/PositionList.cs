...
public class PositionList
{
    ...
    /// <summary>
    /// Returns a randomposition from the list and removes it afterwards.
    /// </summary>
    /// <returns>Random position from list</returns>
    public Vector3 GetRandomPositionAndPop()
    {
    ...
    /// <summary>
    /// Returns a randomposition from the list, but leaves it in the list to be returned again.
    /// </summary>
    /// <returns>Random position from list</returns>
    public Vector3 GetRandomPositionNoPop()
    {
        if(positions.Count <= 0)
        {
            FillList();
